...
type (
	...
	TDSBRepository struct {
		db *gorm.DB
	}
)

func NewTDSBRepository(db *gorm.DB) *TDSBRepository {
	return &TDSBRepository{db: db}
}
...
func (r *TDSBRepository) GetByTenantID(tenantID string) (*TenantDataSourceBack, error) {
